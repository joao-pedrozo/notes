...
Uma aplicação moderna de notas desenvolvida com arquitetura de monorepo, oferecendo uma experiência completa para criação, organização e gerenciamento de notas com suporte a categorias (pastas) e edição em Markdown.
