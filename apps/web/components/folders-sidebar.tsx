  ...
  return (
    <div className="flex w-56 flex-col border-r border-border bg-muted/30">
      <div className="flex items-center justify-between border-b border-border p-4">
        ...
        <Button size="icon" variant="ghost" onClick={onCreateFolder} className="h-7 w-7 cursor-pointer">
      ...
      <div className="flex-1 overflow-y-auto p-2">
        ...
        >
          ...
          <span className="text-xs text-muted-foreground">{totalNotesCount}</span>
        </button>
                ...
                <>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => startEditing(folder)} className="cursor-pointer">
